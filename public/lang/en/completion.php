...
$string['completedunlockedtext'] = 'When you save this form, completion data will be deleted then recalculated where possible. To avoid this, you can navigate away without saving or choose data to keep.';
$string['completedwarning'] = 'Completion options locked';
$string['completedwarningtext'] = 'This activity is marked as done for one or more students. If you unlock the settings to make a change then save the form, completion data will be deleted then recalculated where possible. Manual completion can\'t be recalculated, so in this case the student will need to mark it as done again. You will have options to keep manual and overriden completion states.';
...
$string['keepmanuallycompleted'] = 'Keep manually set completion states';
$string['keepmanuallycompleted_help'] = 'If checked and you save or update unlocked activity settings, states that were completed manually will remain.';
$string['keepoverriddencompletion'] = 'Keep manually overridden completion states';
$string['keepoverriddencompletion_help'] = 'If checked and you save or update unlocked activity settings, states that were overridden manually will remain.';
