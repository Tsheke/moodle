@core @core_course
Feature: Edit course settings to set visibility to Not available
  In order to let the course visible and to prohibit access to anyone without permission to access it when hidden
  As a teacher
  ...
  Scenario: Edit course settings and set visibility to hide
    ...
    And I should not see "This course is not available to students"
    And I log out
  ...
  Scenario: Edit course settings and set visibility to not available
    When I navigate to "Edit settings" in current page administration
    And I set the following fields to these values:
      | Course visibility | Not available |
    And I press "Save and display"
    And I follow "Test course"
    Then I should see "Test course"
    And I should see "C1"
    ...
    Then I should see "Test course"
    And I click on "Test course" "link"
    And I should see "This course is not available to students"
