...
$string['keepmanuallycompleted'] = 'Keep manually completed states';
$string['keepmanuallycompleted_desc'] = 'If checked and you unlock or update activity settings, states that were completed manually will remain';
